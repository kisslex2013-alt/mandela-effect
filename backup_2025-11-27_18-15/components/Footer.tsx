...
export default function Footer() {
  return (
    <footer className="bg-dark border-t border-darkCard py-12 px-4 md:px-8" role="contentinfo">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mb-8">
          {/* Колонка 1: О проекте */}
          <nav aria-label="О проекте" className="text-left">
          ...
          {/* Колонка 2: Навигация */}
          <nav aria-label="Навигация" className="text-left md:text-center">
          ...
          {/* Колонка 3: Контакты */}
          <nav aria-label="Контакты" className="text-left md:text-right">
