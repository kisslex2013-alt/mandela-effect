      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[60vh]">
          ...
          <div className="flex flex-col items-center justify-center order-2 lg:order-1">
            <AiAvatar />
            <div className={`mt-8 font-mono text-xs tracking-[0.3em] uppercase ${
            ...
            >
              ...
              <div className={`text-lg leading-relaxed ${
                ...
                {isUpsideDown ? (
                  <>
                    {conspiracyContent}
                    <p className="mt-6 text-red-400 font-bold border-l-2 border-red-500 pl-4 animate-pulse">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link href="/catalog">
                  <button className={`px-8 py-4 rounded-xl font-bold flex items-center gap-2 transition-all ${
                    isUpsideDown 
                ...
                {!isUpsideDown && (
                  <div className="flex items-center gap-4 px-6 py-4 rounded-xl border border-white/10 bg-white/5 text-xs font-mono text-light/50">
                ...
                {isUpsideDown && (
                   <div className="flex items-center gap-4 px-6 py-4 rounded-xl border border-red-500/30 bg-red-950/20 text-xs font-mono text-red-400/70">
